...
def send_email():
    def send_gmail():
        try:
            ...
            sender_email = "rajeshtej1217@gmail.com"
            password = "Deechu@2016"
...
def bill_area():
    if nameEntry.get()=="" or phoneEntry.get()=="":
        ...
        textArea.delete(1.0,END)
        textArea.insert(END,"\t**Welcome to Shivani Parlour  **\n")
...
root=Tk()
root.title("ADITYA HOME")
root.geometry("1350x815")

#icon will be placed here 
headingLabel=Label(root,text="Aditya Restraunt Billing System",font=("times new roman",30,"bold"),bg="gray20",fg="gold",bd=14,relief=GROOVE)# can be editable after also will ask from all 
